  ...
  return {
    ...
    paint: {
      'circle-color': {
        ...
        stops: [
          [floodTypes.contingenctTank, colors.YELLOW],
          [floodTypes.facility, colors.LIGHT_RED_100],
          [floodTypes.prcFull, colors.LIGHT_BLUE],
          [floodTypes.prcOverfull, colors.MEDIUM_BLUE],
          [floodTypes.privateTank, colors.ORANGE],
          [floodTypes.ROAD, colors.MEDIUM_BLUE],
          [floodTypes.shelter, colors.LIGHT_RED_100],
          [floodTypes.shelterLight, colors.LIGHT_RED_50],
        ],
        type: 'categorical',
      },
      'circle-opacity': 0.9,
