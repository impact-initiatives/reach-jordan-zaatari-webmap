...
export default {
  TITLE_SHORT: {
    ...
    [ARABIC]: "Za'atari - District Boundaries", // TODO: update this
  },
  TITLE_LONG: {
    [ENGLISH]: "Al Za'atari Refugee Camp - District Boundaries",
    [ARABIC]: "Al Za'atari Refugee Camp - District Boundaries", // TODO: update this
  },
  INFO: {
    LANGUAGE: {
      [ENGLISH]: 'Language',
    ...
    ACCURACY: {
      [ENGLISH]: 'All information correct as of October 2016.',
      [ARABIC]: 'جميع المعلومات الصحيحة اعتبارا من أكتوبر 2016.',
    },
    COLLECTED: {
